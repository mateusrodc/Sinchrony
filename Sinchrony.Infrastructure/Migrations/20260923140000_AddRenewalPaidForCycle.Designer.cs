...
namespace Sinchrony.Infrastructure.Migrations
{
    ...
    [Migration("20260923140000_AddRenewalPaidForCycle")]
    partial class AddRenewalPaidForCycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.AdminAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.ClassType", b =>
                {
                    ...
                    b.Property<bool>("UsesJump")
                        .HasColumnType("boolean");

                    b.Property<bool>("UsesPilatesMat")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.Package", b =>
                {
                    ...
                    b.Property<bool>("AllowsCard")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("AllowsInstallments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<bool>("AllowsPix")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.Settings", b =>
                {
                    ...
                    b.Property<string>("ToleranceMode")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.StudentPackage", b =>
                {
                    ...
                    b.Property<Guid?>("RenewalCardId")
                        .HasColumnType("uuid");

                    b.Property<bool>("RenewalPaidForCycle")
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.TeacherUnit", b =>
                {
                    b.Property<Guid>("TeacherId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("TeacherId", "UnitId");

                    b.HasIndex("UnitId");

                    b.ToTable("teacher_units", (string)null);
                });
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.WaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.AdminAlert", b =>
                {
                    b.HasOne("Sinchrony.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sinchrony.Domain.Entities.StudentPackage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.StudentPackage", b =>
                {
                    ...
                    b.HasOne("Sinchrony.Domain.Entities.Card", null)
                        .WithMany()
                        .HasForeignKey("RenewalCardId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Sinchrony.Domain.Entities.UserPermission", b =>
                {
                    ...
                    b.HasOne("Sinchrony.Domain.Entities.Permission", "Permission")
                        .WithMany()
