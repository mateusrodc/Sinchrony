...
public interface IAsaasService
{
    ...
    Task<CardTokenizationResult> TokenizeCardAsync(string number, string holderName, string expiryDate, string cvv, string customerId, CancellationToken ct = default);
}